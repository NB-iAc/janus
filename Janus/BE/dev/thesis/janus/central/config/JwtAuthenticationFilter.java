...
import dev.thesis.janus.central.service.JwtService;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            final String userToken = jwtService.extractUserToken(jwt);
            ...
            if (userToken != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                ...
                if (userOptional.isPresent() && jwtService.isTokenValid(jwt)) {
                    ...
                    logger.debug("Authenticated user ID: {}", user.getUserid());
                }
            }
        } catch (Exception e) {
